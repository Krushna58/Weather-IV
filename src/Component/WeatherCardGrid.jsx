  ...
  return (
    <div className="mt-4 container">
      {averages && (
        <div className="mb-4">
          <div
            className="card border-secondary shadow-sm mx-auto"
          ...
          >
            ...
            <div className="card-body">
              <p>
                ...
                <strong>Temperature:</strong> {averages.temperature.toFixed(2)}
                °C
              </p>
              <p>
                <i class="bi bi-moisture"></i>
                <strong> Humidity:</strong> {averages.humidity.toFixed(2)} %
              </p>
              <p>
                <i class="bi bi-cloud-drizzle"></i>
                <strong> Rainfall:</strong> {averages.rainfall.toFixed(2)} mm
              </p>
            </div>
              ...
              <div className="row">
                <div className="col-6">
                  <small>
                    ...
                    <strong> Sunrise:</strong> {item.sunrise}
                  </small>
                </div>
                <div className="col-6">
                  <small>
                    <i class="bi bi-sunset"></i>
                    <strong> Sunset:</strong> {item.sunset}
                  </small>
                </div>
                <div className="col-6">
                  <i class="bi bi-moon-stars"></i>
                  <small>
                    <strong> Moonrise:</strong> {item.moonrise}
                  </small>
                </div>
                <div className="col-6">
                  <i class="bi bi-moon"></i>
                  <small>
                    <strong> Moonset: </strong> {item.moonset}
                  </small>
                </div>
              </div>
            </div>
